...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Governance-first AI agent orchestration platform. 60 agent capabilities across 10 departments, 9 AI providers, 1,764 tests passing. Free to run locally with Ollama. Patent-pending PhiLattice Architecture and NBMF.',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What is Daena?', acceptedAnswer: { '@type': 'Answer', text: 'Daena is a governance-first AI agent orchestration platform that coordinates 60 agent capabilities across 10 departments with 9 AI providers. Free to run locally with Ollama. Every action passes through a 10-stage governed execution pipeline. 1,764 tests passing.' } },
